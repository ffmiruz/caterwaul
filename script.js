...
const viewSidebar = function(){
  return m("aside", {class:(Model.mobileSidebar == false) ? "offscreen absolute inset-y-0 left-0 sm:static w-80 bg-gray-800 text-white h-full transition"
...
const actDropdown = function() {
  if (Model.userDropdown == true){
    return "viewUserDropdown"
  }
  return ""
}

const viewHeader = 
  m("header",{class:"flex items-center justify-between bg-white text-black p-4 border border-gray-200"}
